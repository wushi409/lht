...
CREATE TABLE IF NOT EXISTS user_accounts (
  ...
  CONSTRAINT uk_user_accounts_student UNIQUE (student_id),
  CONSTRAINT uk_user_accounts_company UNIQUE (company_id),
...
-- ---------------------------------------------------------------------------
-- Interviews, reviews, announcements
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Cross-table constraints added after all tables exist
-- ---------------------------------------------------------------------------
